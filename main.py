...
async def main():
    ...
    udp_ping_responder_port = global_config['hon_data']['svr_starting_gamePort'] - 1 + global_config['hon_data']['man_proxyPortIncrement'] if 'man_enableProxy' in global_config['hon_data'] and global_config['hon_data']['man_enableProxy'] else global_config['hon_data']['svr_starting_gamePort'] - 1
