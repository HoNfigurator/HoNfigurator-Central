    ...
    def get_local_configuration(self):
        ...
        self.local = ({
            ...
            'params' : {
                ...
                'svr_proxyPort':self.get_global_by_key('svr_starting_gamePort')+self.id+1000 - 1,
                'svr_proxyLocalVoicePort':self.get_global_by_key('svr_starting_voicePort')+self.id - 1,
                'svr_proxyRemoteVoicePort':self.get_global_by_key('svr_starting_voicePort')+self.id+1000 - 1,
